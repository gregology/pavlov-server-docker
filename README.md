...
```
docker build -t gregology/pavlov-server:0.30 .
docker push gregology/pavlov-server:0.30
docker tag gregology/pavlov-server:0.30 gregology/pavlov-server:latest
